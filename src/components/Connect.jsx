export default function Connect() {
    return(
        <section className=" flex flex-col w-full items-center pt-10 pb-5">
              <div className="flex flex-col w-[95%] justify-start gap-3 pb-15">
                <div className="w-[5%] h-1.5 bg-[#141414]"></div>
                
                <h2 className="w-[95%] justify-start text-3xl">Connect</h2>
