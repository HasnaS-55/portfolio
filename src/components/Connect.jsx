export default function Connect() {
    ...
    window.open('https://www.linkedin.com/in/hasna-salihi-78b307367/', '_blank', 'noopener,noreferrer');
  }

  const handleEmailClick = () => {
    window.location.href = 'mailto:salihihasna02@gmail.com';
  }

  const handlePhoneClick = () => {
    window.open('tel:+212654584058');
  }
  return (
    <section className=" flex flex-col w-full items-center pt-10 pb-5">
      ...
      <div className="flex flex-col w-[95%] justify-start gap-3">
        ...
        <h2 className="justify-start text-5xl lg:text-6xl">
      ...
      <div className="flex h-55 relative w-[95%] justify-center items-center ">
        ...
        <button onClick={handleLinkedInClick} className="h-45 w-45 text-[#F7F7F7] text-xl absolute  right-10  z-10 bg-[#141414] rounded-full lg:w-55 lg:h-55 lg:right-20">
          Click Here
        </button>
      </div>
      <div className="flex w-[95%] justify-start items-center gap-10">
        <div onClick={handleEmailClick} className="flex flex-col items-start gap-2">
          <svg
            width="30"
            height="30"
            viewBox="0 0 30 30"
        ...
        <div onClick={handlePhoneClick} className="flex flex-col items-start gap-2">
          <svg
            width="30"
            height="30"
            viewBox="0 0 30 30"
