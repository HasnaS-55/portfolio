        ...
        <div className=" w-[95%] flex items-start justify-between absolute top-8  z-10">
          ...
          <div className="w-[50%] text-right text-[#F4F4F4] text-sm lg:text-lg lg:w-[40%]">
            <p>
              ...
              functionality to build fast, accessible, and user-centric
              applications.
            </p>
          </div>
        </div>
        <div className="w-full flex flex-col justify-center items-center gap-26">
          ...
          <div className="w-full">
            <ScrollVelocity
              ...
              className=" text-7xl text-white custom-scroll-text lg:text-9xl"
            />
          </div>
          <div className="mb-6">
            <NavBar />
